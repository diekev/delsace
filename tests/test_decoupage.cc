...
decoupeuse_texte decoupeuse(str, str + len);
	...
	const DonneesMorceaux donnees_morceaux[] = {
		{ "soit", 0ul, 0ul, ID_SOIT },
		{ "str", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "=", 0ul, 0ul, ID_EGAL },
		{ "a", 0ul, 0ul, ID_CARACTERE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE },
		{ "soit", 0ul, 0ul, ID_SOIT },
		{ "str0", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "=", 0ul, 0ul, ID_EGAL },
		{ "\\0", 0ul, 0ul, ID_CARACTERE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE },
		{ "associe", 0ul, 0ul, ID_ASSOCIE },
		{ "nombre", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "{", 0ul, 0ul, ID_ACCOLADE_OUVRANTE },
		{ "0", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ "...", 0ul, 0ul, ID_TROIS_POINTS },
		{ "1_000", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ ":", 0ul, 0ul, ID_DOUBLE_POINTS },
		{ "imprime", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "(", 0ul, 0ul, ID_PARENTHESE_OUVRANTE },
		{ "1000", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ ")", 0ul, 0ul, ID_PARENTHESE_FERMANTE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE },
		{ "11_000", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ "...", 0ul, 0ul, ID_TROIS_POINTS },
		{ "2_0000", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ ":", 0ul, 0ul, ID_DOUBLE_POINTS },
		{ "imprime", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "(", 0ul, 0ul, ID_PARENTHESE_OUVRANTE },
		{ "20000", 0ul, 0ul, ID_NOMBRE_ENTIER },
		{ ")", 0ul, 0ul, ID_PARENTHESE_FERMANTE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE },
		{ "sinon", 0ul, 0ul, ID_SINON },
		{ ":", 0ul, 0ul, ID_DOUBLE_POINTS },
		{ "imprime", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "(", 0ul, 0ul, ID_PARENTHESE_OUVRANTE },
		{ "inconnu", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ ")", 0ul, 0ul, ID_PARENTHESE_FERMANTE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE },
		{ "}", 0ul, 0ul, ID_ACCOLADE_FERMANTE },
		{ "decoupeuse_texte", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "decoupeuse", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "(", 0ul, 0ul, ID_PARENTHESE_OUVRANTE },
		{ "str", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ ",", 0ul, 0ul, ID_VIRGULE },
		{ "str", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ "+", 0ul, 0ul, ID_PLUS },
		{ "len", 0ul, 0ul, ID_CHAINE_CARACTERE },
		{ ")", 0ul, 0ul, ID_PARENTHESE_FERMANTE },
		{ ";", 0ul, 0ul, ID_POINT_VIRGULE }
	};
