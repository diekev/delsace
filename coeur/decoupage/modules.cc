		...
		bool est_racine)
{
	...
	module->temps_chargement = numero7::chronometrage::maintenant() - debut_chargement;

	auto debut_tampon = numero7::chronometrage::maintenant();
	module->tampon = TamponSource(tampon);
	module->temps_tampon = numero7::chronometrage::maintenant() - debut_tampon;

	auto decoupeuse = decoupeuse_texte(module);
	auto debut_decoupage = numero7::chronometrage::maintenant();
	decoupeuse.genere_morceaux();
	module->temps_decoupage = numero7::chronometrage::maintenant() - debut_decoupage;
	...
	auto debut_analyse = numero7::chronometrage::maintenant();
	analyseuse.lance_analyse(os);
	module->temps_analyse = numero7::chronometrage::maintenant() - debut_analyse;
}
