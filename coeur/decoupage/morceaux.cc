...
const char *chaine_identifiant(int identifiant)
{
	switch (identifiant) {
		...
		case IDENTIFIANT_E16:
			return "IDENTIFIANT_E16";
		case IDENTIFIANT_E16NS:
			return "IDENTIFIANT_E16NS";
		case IDENTIFIANT_E32:
			return "IDENTIFIANT_E32";
		case IDENTIFIANT_E32NS:
			return "IDENTIFIANT_E32NS";
		case IDENTIFIANT_E64:
			return "IDENTIFIANT_E64";
		case IDENTIFIANT_E64NS:
			return "IDENTIFIANT_E64NS";
		case IDENTIFIANT_E8:
			return "IDENTIFIANT_E8";
		case IDENTIFIANT_E8NS:
			return "IDENTIFIANT_E8NS";
		...
		case IDENTIFIANT_R16:
			return "IDENTIFIANT_R16";
		case IDENTIFIANT_R32:
			return "IDENTIFIANT_R32";
		case IDENTIFIANT_R64:
			return "IDENTIFIANT_R64";
		...
		case IDENTIFIANT_NOMBRE_ENTIER:
			return "IDENTIFIANT_NOMBRE_ENTIER";
		case IDENTIFIANT_NOMBRE_REEL:
			return "IDENTIFIANT_NOMBRE_REEL";
		case IDENTIFIANT_NOMBRE_BINAIRE:
			return "IDENTIFIANT_NOMBRE_BINAIRE";
		case IDENTIFIANT_NOMBRE_OCTAL:
			return "IDENTIFIANT_NOMBRE_OCTAL";
		case IDENTIFIANT_NOMBRE_HEXADECIMAL:
			return "IDENTIFIANT_NOMBRE_HEXADECIMAL";
