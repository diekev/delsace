...
DialogueCouleur::DialogueCouleur(QWidget *parent)
	: QDialog(parent)
	, m_disposition(new QVBoxLayout())
	, m_disposition_sel_ct(new QVBoxLayout())
	, m_disposition_sel_cv(new QHBoxLayout())
	, m_disposition_horiz(new QHBoxLayout())
	, m_disposition_rvba(new QGridLayout())
	, m_disposition_boutons(new QHBoxLayout())
	, m_selecteur_sat_val(new ControleSatVal(this))
	, m_selecteur_teinte(new SelecteurTeinte(this))
	, m_selecteur_valeur(new ControleValeurCouleur(this))
	, m_r(new ControleNombreDecimal(this))
	, m_v(new ControleNombreDecimal(this))
	, m_b(new ControleNombreDecimal(this))
	, m_h(new ControleNombreDecimal(this))
	, m_s(new ControleNombreDecimal(this))
	, m_v0(new ControleNombreDecimal(this))
	, m_a(new ControleNombreDecimal(this))
	, m_affichage_couleur_nouvelle(new AffichageCouleur(converti_couleur(m_couleur_nouvelle), this))
	, m_affichage_couleur_originale(new AffichageCouleur(converti_couleur(m_couleur_origine), this))
	, m_contraste(new QLabel("", this))
{
	...
	connect(m_h, &ControleNombreDecimal::valeur_changee, this, &DialogueCouleur::ajourne_couleur_hsv);
	connect(m_s, &ControleNombreDecimal::valeur_changee, this, &DialogueCouleur::ajourne_couleur_hsv);
	connect(m_v0, &ControleNombreDecimal::valeur_changee, this, &DialogueCouleur::ajourne_couleur_hsv);
	connect(m_a, &ControleNombreDecimal::valeur_changee, this, &DialogueCouleur::ajourne_couleur);
	connect(m_selecteur_sat_val, &ControleSatVal::valeur_changee, this, &DialogueCouleur::ajourne_couleur_sat_val);
	connect(m_selecteur_teinte, &SelecteurTeinte::valeur_changee, this, &DialogueCouleur::ajourne_couleur_teinte);
	connect(m_selecteur_valeur, &ControleValeurCouleur::valeur_changee, this, &DialogueCouleur::ajourne_couleur_valeur);
