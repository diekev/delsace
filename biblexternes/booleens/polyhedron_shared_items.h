...
#if (0)
// compute halfedge normal : ajout Celine
...
#if (0)
		// normal
		Norm m_normal;  // AJOUT Celine : halfedge normal (sum of 2 incident facet normals)
#endif
...
class MEPP_Common_Polyhedron : public CGAL::Polyhedron_3<kernel,items>
{
	...
	public:
...
#if (0)
			compute_normals_per_halfedge();  // ajout Celine
#endif
		}
		...
		bool load_mesh(string path)
		{
			...
			/*MEPP: if (extension != "DAT" && extension != "BW")  // ajout Celine
				this->fit_mesh();*/
	...
	protected:
		...
		bool load_mesh_dat(string filename)
		{
			...
			// on recupere le nombre de niveaux de resolution du polyedre semi-regulier :
