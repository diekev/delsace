...
public: //--------------------------------------------------- memory management
	...
	unsigned int verticesSize() const { return static_cast<unsigned int>(m_vprops.size()); }
    /// returns number of (deleted and valid)halfedge in the mesh
	unsigned int halfedgesSize() const { return static_cast<unsigned int>(m_hprops.size()); }
    /// returns number of (deleted and valid)edges in the mesh
	unsigned int edgesSize() const { return static_cast<unsigned int>(m_eprops.size()); }
    /// returns number of (deleted and valid)faces in the mesh
	unsigned int facesSize() const { return static_cast<unsigned int>(m_fprops.size()); }
