...
struct BSDF {
	...
	virtual void evalue_echantillon(GNA &gna, const ParametresRendu &parametres, const numero7::math::vec3d &dir, Spectre &L, double &pdf) = 0;

	virtual void genere_echantillon(GNA &gna, const ParametresRendu &parametres, numero7::math::vec3d &dir, Spectre &L, double &pdf, int profondeur) = 0;
...
struct BSDFTrivial : public BSDF {
	...
	void evalue_echantillon(GNA &gna, const ParametresRendu &parametres, const numero7::math::vec3d &dir, Spectre &L, double &pdf) override;

	void genere_echantillon(GNA &gna, const ParametresRendu &parametres, numero7::math::vec3d &dir, Spectre &L, double &pdf, int profondeur) override;
};
