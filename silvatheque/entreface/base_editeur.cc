...
BaseEditrice::BaseEditrice(Silvatheque &silvatheque, QWidget *parent)
...
{
	if (m_silvatheque->widget_actif) {
		m_silvatheque->widget_actif->actif(false);
	}

	m_silvatheque->widget_actif = this;
	this->actif(true);
}
