...
# This module defines
#  INCLUSIONS_TEST_UNITAIRE, where to find test_unitaire.h, Set when
#                    TEST_UNITAIRE is found.
#  BIBLIOTHEQUES_TEST_UNITAIRE, libraries to link against to use TEST_UNITAIRE.
...
if(TEST_UNITAIRE_FOUND)
	set(BIBLIOTHEQUES_TEST_UNITAIRE ${TEST_UNITAIRE_LIBRARY})
	set(INCLUSIONS_TEST_UNITAIRE ${TEST_UNITAIRE_INCLUDE_DIR} ${TEST_UNITAIRE_INCLUDE_DIR}/../)
else()
