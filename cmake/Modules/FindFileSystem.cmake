...
# This module defines
#  INCLUSIONS_SYSFICHIER, where to find filesystem.h, Set when
#                    FILESYSTEM is found.
#  BIBLIOTHEQUES_SYSFICHIER, libraries to link against to use FILESYSTEM.
...
if(FILESYSTEM_FOUND)
	set(BIBLIOTHEQUES_SYSFICHIER ${FILESYSTEM_LIBRARY} stdc++fs)
	set(INCLUSIONS_SYSFICHIER ${FILESYSTEM_INCLUDE_DIR} ${FILESYSTEM_INCLUDE_DIR}/../)
else()
