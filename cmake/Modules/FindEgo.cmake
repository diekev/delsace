...
# This module defines
#  INCLUSIONS_EGO, where to find ego.h, Set when
#                    EGO is found.
#  BIBLIOTHEQUES_EGO, libraries to link against to use EGO.
...
if(EGO_FOUND)
	set(BIBLIOTHEQUES_EGO ${EGO_LIBRARY})
	set(INCLUSIONS_EGO ${EGO_INCLUDE_DIR})
else()
	set(EGO_FOUND FALSE)
endif()
