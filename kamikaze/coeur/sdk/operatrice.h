...
/**
 * @brief nouvel_operatrice_kamikaze Interface pour enregistrer un nouvel
...
/**
 * Enveloppe autour d'une PriseEntree pour restreindre l'entreface de celle-ci.
 */
 ...
 */
enum type_operatrice {
	STATIC    = 0,
	DYNAMIQUE = 1,
};

/**
 * L'Operatrice enveloppe la logique de manipulation des Primitives. Chaque
...
class Operatrice : public danjo::Manipulable {
	...
	std::vector<EntreeOperatrice> m_donnees_entree{};
...
public:
	 ...
	 */
	virtual type_operatrice type() const;
	...
	/**
	 * Retourne le chemin vers la définition de l'entreface de cet opérateur.
	 */
...
struct DescOperatrice {
	...
	fonction_usine construction_operatrice = nullptr;
