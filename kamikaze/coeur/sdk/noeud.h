...
/**
 * La classe Noeud englobe un opérateur, et est le pont entre l'entreface
...
public:
	...
	/**
	 * Retourne si oui ou non le noeud a une connexion entrante ou sortante.
	 */
	 ...
	 */
	void operatrice(Operatrice *operatrice);

	/**
	 * Retourne l'opérateur installé dans ce noeud.
	 */
	Operatrice *operatrice() const;
