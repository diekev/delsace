...
class Geometry_traits<Mesh, CGAL::Exact_predicates_inexact_constructions_kernel>
    : public Geometry_traits_for_cgal<Mesh, CGAL::Exact_predicates_inexact_constructions_kernel> {
    typedef Geometry_traits_for_cgal<Mesh, CGAL::Exact_predicates_inexact_constructions_kernel>
        Base;
