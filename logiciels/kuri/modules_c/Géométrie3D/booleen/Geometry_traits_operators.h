...
typename GeometryTraits::Vector add_v(const typename GeometryTraits::Vector &v1,
 ...
 */
template <typename GeometryTraits>
typename GeometryTraits::Point add_pv(const typename GeometryTraits::Point &p,
 ...
 */
template <typename GeometryTraits>
typename GeometryTraits::Point sub_pv(const typename GeometryTraits::Point &p,
                                      const typename GeometryTraits::Vector &v)
{
    typedef typename GeometryTraits::Point Point;
    Point result(p[0] - v[0], p[1] - v[1], p[2] - v[2]);
 ...
 */
template <typename GeometryTraits>
typename GeometryTraits::Vector sub_p(const typename GeometryTraits::Point &p1,
 ...
 */
template <typename GeometryTraits>
typename GeometryTraits::Vector sub_v(const typename GeometryTraits::Vector &v1,
                                      const typename GeometryTraits::Vector &v2)
{
    typedef typename GeometryTraits::Vector Vector;
    Vector result(v1[0] - v2[0], v1[1] - v2[1], v1[2] - v2[2]);
 ...
 */
template <typename GeometryTraits>
typename GeometryTraits::Scalar dot_product(const typename GeometryTraits::Vector &v1,
                                            const typename GeometryTraits::Vector &v2)
{
