...
//
//  According to :
// 	"Exact and Efficient Booleans for Polyhedra", C. Leconte, H. Barki, F. Dupont, Rapport de
// recherche RR-LIRIS-2010-018, 2010
//
///////////////////////////////////////////////////////////////////////////
...
void Boolean_Operations_Component::Boolean_Union(PolyhedronPtr pMin1,
                                                 PolyhedronPtr pMin2,
                                                 PolyhedronPtr pMout)
{
...
void Boolean_Operations_Component::Boolean_Inter(PolyhedronPtr pMin1,
                                                 PolyhedronPtr pMin2,
                                                 PolyhedronPtr pMout)
{
    //*
...
void Boolean_Operations_Component::Boolean_Minus(PolyhedronPtr pMin1,
                                                 PolyhedronPtr pMin2,
                                                 PolyhedronPtr pMout)
{
    //*
