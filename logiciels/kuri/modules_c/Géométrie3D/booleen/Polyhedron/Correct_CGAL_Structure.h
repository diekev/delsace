                        ...
                        for (unsigned l = 0; l < (*Facets)[Potential_neighbor_facet].size(); l++) {
                            ...
                            if (Vertex_index == Second_vert_index) {
                                ...
                                if (Check_orientation_problem == false) {
                                    int FV_position = -1;
                                    for (unsigned m = 0;
                                         m < (*Facets)[Potential_neighbor_facet].size();
                                         m++) {
                                        if ((*Facets)[Potential_neighbor_facet][m] ==
                                            First_vert_index) {
                                            FV_position = m;
                                            break;
                                        }
                                    ...
                                    if ((FV_position - l != 1) &&
                                        (l - FV_position !=
                                         (*Facets)[Potential_neighbor_facet].size() - 1))
                ...
                while (!Queue.empty()) {
                    ...
                    if (Status_facets[Current_facet] != -1)
                        ...
                        for (unsigned i = 0; i < Neighboring_facets[Current_facet].size(); i++) {
                            ...
                            if ((Status_facets[Neighbor_index] == -1) &&
                                (Reoriented_facet[Neighbor_index] == -1)) {
                                int First_vert_index, Second_vert_index;

                                if (Reoriented_facet[Current_facet] ==
                                    0)  // current_facet is not reoriented;
                                {
                                    First_vert_index = Neighboring_edges[Current_facet][2 * i];
                                    Second_vert_index =
                                        Neighboring_edges[Current_facet][2 * i + 1];
                                }
                                ...
                                if ((FV_position - SV_position == 1) ||
                                    (SV_position - FV_position ==
                                     (int)(*Facets)[Neighbor_index].size() - 1)) {
