...
#include "../Boolean_Operations_Items.h"

template <class Refs, class T, class P, class Norm, class Plane>
class Enriched_facet :
    /*************** HERITAGE FACETTE ***************/
    public Boolean_Operations_Facet<Refs, T, P, Norm, Plane>,
    /*************************************************/
...
class Enriched_halfedge :
    /*************** HERITAGE HALFEDGE ***************/
    public Boolean_Operations_Halfedge<Refs, Tprev, Tvertex, Tface, Norm>,
    /*************************************************/
...
class Enriched_vertex :
    /*************** HERITAGE VERTEX ***************/
    public Boolean_Operations_Vertex<Refs, T, P, Norm>,
    /*************************************************/
  ...
  public:
    ...
    // On a besoin d'appeller explicitement le constructeur(pt) de base pour la création de
    // polyhedre
...
struct Enriched_items : public Polyhedron_items_3 {
    // wrap vertex
    template <class Refs, class Traits>
    struct Vertex_wrapper {
        typedef typename Traits::Point_3 Point;
        typedef typename Traits::Vector_3 Normal;
        typedef Enriched_vertex<Refs, Tag_true, Point, Normal> Vertex;
    };
    ...
    struct Face_wrapper {
        ...
        typedef Enriched_facet<Refs, Tag_true, Point, Normal, Plane> Face;
    };
    ...
    struct Halfedge_wrapper {
        typedef typename Traits::Vector_3 Normal;
        typedef Enriched_halfedge<Refs, Tag_true, Tag_true, Tag_true, Normal> Halfedge;
    };
};
...
class Enriched_polyhedron :
    /*************** HERITAGE POLYHEDRON ***************/
    public Boolean_Operations_Polyhedron<kernel, items>,
    /*************************************************/
