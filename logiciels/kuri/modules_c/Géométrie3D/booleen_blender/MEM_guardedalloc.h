 ...
 */
template <typename T>
inline T *MEM_cnew(const char *allocation_name)
{
 ...
 */
template <typename T>
inline T *MEM_cnew(const char *allocation_name, const T &other)
{
    static_assert(std::is_trivial_v<T>, "For non-trivial types, MEM_new should be used.");
...
#    define MEM_CXX_CLASS_ALLOC_FUNCS(_id)                                                        \
      public:                                                                                     \
        ...
        /* This is the matching delete operator to the placement-new operator above. Both         \
         * parameters will have the same value. Without this, we get the warning C4291 on                              \
         * windows. */                                                                            \
