...
class container_periodic_base : public unitcell, public voro_base {
  public:
     ...
     * the particle radii. */
    const int ps;
    container_periodic_base(double bx_,
                            double bxy_,
                            double by_,
                            double bxz_,
                            double byz_,
    ...
    container_periodic_base(container_periodic_base const &) = default;
    container_periodic_base &operator=(container_periodic_base &) = default;
    ...
    inline bool initialize_voronoicell(v_cell &c,
                                       int ijk,
                                       int q,
                                       int ci,
                                       int cj,
     ...
     *		    in this instance.) */
    inline void initialize_search(
        int ci, int cj, int ck, int ijk, int &i, int &j, int &k, int &disp)
    {
        i = nx;
        j = ey;
        k = ez;
    ...
    inline int region_index(int ci,
                            int cj,
                            int ck,
                            int ei,
                            int ej,
  ...
  protected:
    ...
    inline void create_periodic_image(int di, int dj, int dk)
    {
        if (di < 0 || di >= nx || dj < 0 || dj >= oy || dk < 0 || dk >= oz)
            voro_fatal_error("Constructing periodic image for nonexistent point",
...
class container_periodic_poly : public container_periodic_base, public radius_poly {
  public:
    container_periodic_poly(double bx_,
                            double bxy_,
                            double by_,
                            double bxz_,
                            double byz_,
