...
class pre_container_base {
  public:
    ...
    pre_container_base(pre_container_base const &) = default;
    pre_container_base &operator=(pre_container_base const &) = default;
    ...
    {
        return static_cast<int>((end_id - pre_id) * pre_container_chunk_size + (ch_id - *end_id));
    }
...
class pre_container : public pre_container_base {
  public:
    ...
    pre_container(double ax_,
                  ...
                  bool zperiodic_)
        : pre_container_base(
              ax_, bx_, ay_, by_, az_, bz_, xperiodic_, yperiodic_, zperiodic_, 3){};
...
class pre_container_poly : public pre_container_base {
  public:
    ...
    pre_container_poly(double ax_,
                       ...
                       bool zperiodic_)
        : pre_container_base(
              ax_, bx_, ay_, by_, az_, bz_, xperiodic_, yperiodic_, zperiodic_, 4){};
