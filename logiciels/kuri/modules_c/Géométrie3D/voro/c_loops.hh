...
class particle_order {
  public:
    ...
    particle_order(particle_order const &) = default;
    particle_order &operator=(particle_order const &) = default;
...
class c_loop_base {
  public:
    ...
    c_loop_base(c_class &con)
        : nx(con.nx), ny(con.ny), nz(con.nz), nxy(con.nxy), nxyz(con.nxyz), ps(con.ps), p(con.p),
          id(con.id), co(con.co)
    {
    }
...
class c_loop_subset : public c_loop_base {
  public:
    ...
    c_loop_subset(c_class &con)
        : c_loop_base(con), ax(con.ax), ay(con.ay), az(con.az), sx(con.bx - ax), sy(con.by - ay),
          sz(con.bz - az), xsp(con.xsp), ysp(con.ysp), zsp(con.zsp), xperiodic(con.xperiodic),
          yperiodic(con.yperiodic), zperiodic(con.zperiodic)
    {
    }
...
class c_loop_all_periodic : public c_loop_base {
  public:
    ...
    c_loop_all_periodic(c_class &con)
        : c_loop_base(con), ey(con.ey), ez(con.ez), wy(con.wy), wz(con.wz),
