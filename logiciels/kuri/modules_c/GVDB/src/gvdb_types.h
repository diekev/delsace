...
#        else
// No equivalent of _declspec(dllimport) - see
...
#define COLORA(r, g, b, a)                                                                        \
    ((uint((a)*255.0f) << 24) | (uint((b)*255.0f) << 16) | (uint((g)*255.0f) << 8) |              \
     uint((r)*255.0f))
...
#define LOGI(...)                                                                                 \
    {                                                                                             \
        gprintfLevel(0, __VA_ARGS__);                                                             \
    }
#define LOGW(...)                                                                                 \
    {                                                                                             \
        gprintfLevel(1, __VA_ARGS__);                                                             \
    }
#define LOGE(...)                                                                                 \
    {                                                                                             \
        gprintfLevel(2, __FILE__ "(" S__LINE__ "): "__VA_ARGS__);                                 \
    }
#define LOGOK(...)                                                                                \
    {                                                                                             \
        gprintfLevel(7, __VA_ARGS__);                                                             \
    }
