...
extern "C" GVDB_API void PERF_INIT(
    int buildbits, bool cpu, bool gpu, bool cons, int lev, const char *fname);
...
// JD = Julian Day is the number of days elapsed since Jan 1, 4713 BC in the proleptic Julian
// calendar.
...
class TimeX {
  public:
    ...
    bool SetTime(int hr,
                 ...
                 int s,
                 int ms,
                 int ns);  // Set hr/min, month, day, year, sec, ms, ns
    bool SetTime(TimeX &t)
    {
        m_CurrTime = t.GetSJT();
        return true;
    }                                // Set to another Time object
    ...
    void SetSJT(sjtime t)
    {
        m_CurrTime = t;
    }  // Set Scaled Julian Time directly
