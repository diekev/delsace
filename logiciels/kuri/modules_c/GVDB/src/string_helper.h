...
GVDB_API bool strToVec(std::string &str,
                       std::string lsep,
                       std::string insep,
                       std::string rsep,
                       float *vec,
                       int cpt = 3);
GVDB_API bool strToVec3(
    std::string &str, std::string lsep, std::string insep, std::string rsep, float *vec);
GVDB_API bool strToVec4(
    std::string &str, std::string lsep, std::string insep, std::string rsep, float *vec);
...
GVDB_API bool getFileLocation(const char *filename,
                              char *outpath,
