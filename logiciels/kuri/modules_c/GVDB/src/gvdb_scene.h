...
class GVDB_API Scene {
  public:
    ...
    int getProgram(int prog_id)
    {
        return mProgram[prog_id];
    }
    ...
    int getFrameSamples()
    {
        return mFrameSamples;
    }
    void setFrameSamples(int n)
    {
        mFrameSamples = n;
    }
    ...
    int getParam(int prog_id, int id)
    {
        return mParams[mProgToSlot[mProgram[prog_id]]].p[id];
    }
    bool useOverride()
    {
        return clrOverride;
    }
    Vector3DF getShadowParams()
    {
        return mShadowParams;
    }
    Vector3DI getFrameRange()
    {
        return mVFrames;
    }
    int getNumLights()
    ...
    Vector3DI getRes()
    {
        return Vector3DI(mXres, mYres, 0);
    }
    Vector4DF *getTransferFunc()
    {
        return mTransferFunc;
    }

    Vector4DF getBackClr()
    {
        return mBackgroundClr;
    }
    Vector3DF getExtinct()
    {
        return mExtinct;
    }
    Vector3DF getCutoff()
    ...
    Vector3DF getSectionPnt()
    {
        return mSectionPnt;
    }
    Vector3DF getSectionNorm()
    {
        return mSectionNorm;
    }
    int getShading()
    ...
    {
        mSteps.Set(directStep, shadowStep, fineStep);
    }
    void SetCutoff(float a, float b, float c)
    {
        mCutoff.Set(a, b, c);
    }
    void SetBackgroundClr(float r, float g, float b, float a)
    {
        mBackgroundClr.Set(r, g, b, a);
    }
    void SetCrossSection(Vector3DF pos, Vector3DF norm)
    {
        mSectionPnt = pos;
        mSectionNorm = norm;
    }
    void SetShading(uchar s)
    {
        mShading = s;
    }
    void SetShadowParams(float x, float y, float z)
    {
        mShadowParams.Set(x, y, z);
    }
