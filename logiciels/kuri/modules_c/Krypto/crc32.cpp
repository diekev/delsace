...
{
    buffer[0] = static_cast<unsigned char>((m_hash >> 24) & 0xFF);
    buffer[1] = static_cast<unsigned char>((m_hash >> 16) & 0xFF);
    buffer[2] = static_cast<unsigned char>((m_hash >> 8) & 0xFF);
    buffer[3] = static_cast<unsigned char>(m_hash & 0xFF);
}
