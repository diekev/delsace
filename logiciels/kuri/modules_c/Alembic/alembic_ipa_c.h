...
struct Abc_Attribute_Type_Descriptor {
    Abc_String type_geom;
    Abc_String type_ipa;
    Abc_String nom_court;
};
...
enum Abc_Object_Visibility {
    ABC_OBJECT_VISIBILITY_DEFERRED = -1,
    ABC_OBJECT_VISIBILITY_HIDDEN = 0,
    ABC_OBJECT_VISIBILITY_VISIBLE = 1,
};
