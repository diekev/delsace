...
public:
	...
	NoeudBloc *cree_bloc_seul(const Lexeme *lexeme);
	...
	NoeudExpression *cree_lit_bool(const Lexeme *lexeme);
	NoeudExpression *cree_lit_caractere(const Lexeme *lexeme);
	NoeudExpression *cree_lit_chaine(const Lexeme *lexeme);
	NoeudExpression *cree_lit_entier(const Lexeme *lexeme);
	NoeudExpression *cree_lit_entier(const Lexeme *lexeme, Type *type, unsigned long valeur);
	NoeudExpression *cree_lit_nul(const Lexeme *lexeme);
	NoeudExpression *cree_lit_reel(const Lexeme *lexeme);
	NoeudExpression *cree_lit_reel(const Lexeme *lexeme, Type *type, double valeur);
