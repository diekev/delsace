...
public:
	...
	NoeudDeclarationVariable *cree_declaration_variable(Lexeme const *lexeme);
	...
	NoeudExpressionLitterale *cree_litterale_bool(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_caractere(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_chaine(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_entier(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_entier(const Lexeme *lexeme, Type *type, unsigned long valeur);
	NoeudExpressionLitterale *cree_litterale_nul(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_reel(const Lexeme *lexeme);
	NoeudExpressionLitterale *cree_litterale_reel(const Lexeme *lexeme, Type *type, double valeur);
	NoeudExpression *cree_non_initialisation(const Lexeme *lexeme);
	NoeudExpression *cree_reference_type(const Lexeme *lexeme);
