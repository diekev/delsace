...
void precompile_objet_r16(const kuri::chemin_systeme &chemin_racine_kuri)
{
    ...
    {
        const auto chemin_objet = kuri::chemin_systeme::chemin_temporaire("r16_tables_x64.o");
    ...
    {
        const auto chemin_fichier = chemin_racine_kuri / "fichiers/r16_tables.cc";
        const auto chemin_objet = kuri::chemin_systeme::chemin_temporaire(
            "lib/x86_64-linux-gnu/libr16.so");
