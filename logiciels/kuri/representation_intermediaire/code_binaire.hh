...
// À FAIRE(gestion) : les fonctions auront leurs codes générées plusieurs fois.
//                    nous pouvons pas optimiser car les globales sont stockées via dans les
//                    métprogrammes, et les patchs de globales sont alors invalides/manquants.
class ConvertisseuseRI {
    ...
    /* Les index des globales dans la liste des globales du métaprogramme. */
    kuri::table_hachage<AtomeGlobale *, int> index_globales{};

public:
    ConvertisseuseRI(EspaceDeTravail *espace_, MetaProgramme *metaprogramme_) : espace(espace_), metaprogramme(metaprogramme_)
    {
    }
