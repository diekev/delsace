...
#define CHAINE_CAS(x) \
	...
	switch (inst) {
		...
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_CELLULE)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_FOURIER)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_ONDELETTE)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_SIMPLEX)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_F1)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_F2)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_F3)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_F4)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_F1F2)
		CHAINE_CAS(code_inst::FN_BRUIT_TURBULENT_VORONOI_CR)
	}
