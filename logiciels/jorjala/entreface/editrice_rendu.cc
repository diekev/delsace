...
EditriceRendu::EditriceRendu(Jorjala &jorjala, QWidget *parent)
    : BaseEditrice(jorjala, parent), m_widget(new QWidget()),
...
void EditriceRendu::ajourne_etat(int evenement)
{
    ...
    auto disposition = m_jorjala.gestionnaire_entreface->compile_entreface_texte(donnees, texte);
...
{
    m_jorjala.nom_calque_sortie = m_manipulable.evalue_chaine("nom_calque");
    m_jorjala.chemin_sortie = m_manipulable.evalue_chaine("chemin");
}

void EditriceRendu::obtiens_liste(dls::chaine const & /*attache*/,
