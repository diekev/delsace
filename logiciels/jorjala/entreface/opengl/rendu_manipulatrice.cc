...
static void ajoute_baton_axe(dls::math::vec3f const &min,
                             ...
                             dls::tableau<unsigned int> &indices)
{
    ...
    const dls::math::vec3f coins[8] = {dls::math::vec3f(min[0], min[1], min[2]),
...
static void ajoute_poignee_axe(dls::math::vec3f const &min,
                               dls::math::vec3f const &max,
                               dls::tableau<dls::math::vec3f> &sommets,
                               dls::tableau<unsigned int> &indices)
{
