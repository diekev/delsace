...
Triangle::Triangle(const Triangle::type_vec &v_0,
                   const Triangle::type_vec &v_1,
                   const Triangle::type_vec &v_2)
    : Triangle()
{
    v0 = v_0;
    v1 = v_1;
...
dls::tableau<Triangle> convertis_maillage_triangles(const Corps *corps_entree,
