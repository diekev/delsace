  ...
  public:
    ...
    auto *valeur(long idx)
    {
        ...
        return reinterpret_cast<T *>(
            &(*m_tampon)[idx * dimensions * static_cast<long>(sizeof(T))]);
    }
...
enum {
    ...
    TRANSFERE_TOUT = (TRANSFERE_ATTR_POINTS | TRANSFERE_ATTR_PRIMS | TRANSFERE_ATTR_CORPS |
                      TRANSFERE_ATTR_GROUPES | TRANSFERE_ATTR_SOMMETS)
};
...
struct TransferanteAttribut {
  ...
  public:
    TransferanteAttribut(Corps const &corps_orig,
                         Corps &corps_dest,
                         int drapeaux = TRANSFERE_TOUT);
