...
static auto trouve_sommet(Polyedre &polyedre,
...
static auto ajoute_triangle(Polyedre &polyedre,
                            AccesseusePointLecture const &points,
    ...
    pour_chaque_polygone_ferme(corps, [&](Corps const &, Polygone const *poly) {
        ...
        if (nombre_sommets == 3) {
            ...
            ajourne_label_arete_triangle(
                t, poly->index_sommet(0), poly->index_sommet(1), poly->index_sommet(2));
        }
            ...
            for (auto i = 2; i < poly->nombre_sommets(); ++i) {
                ...
                ajourne_label_arete_triangle(
                    t, poly->index_sommet(0), poly->index_sommet(i - 1), poly->index_sommet(i));
            }
        }
    });
