...
static void anime_image(Jorjala *jorjala)
{
...
public:
	int execute(std::any const &pointeur, DonneesCommande const &donnees) override
	{
		...
		if (donnees.metadonnee == "va_image_debut") {
			jorjala->temps_courant = jorjala->temps_debut;
			...
			if (jorjala->temps_courant < jorjala->temps_debut) {
