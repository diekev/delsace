...
class GridCgInterface {
  public:
    ...
    // precond
    virtual void setICPreconditioner(PreconditionType method,
                                     wlk::grille_dense_3d<float> *A0,
                                     wlk::grille_dense_3d<float> *Ai,
                                     wlk::grille_dense_3d<float> *Aj,
                                     wlk::grille_dense_3d<float> *Ak) = 0;
...
class GridCg : public GridCgInterface {
  public:
    //! constructor
    GridCg(wlk::grille_dense_3d<float> &dst,
    ...
    void setICPreconditioner(PreconditionType method,
                             wlk::grille_dense_3d<float> *A0,
                             wlk::grille_dense_3d<float> *Ai,
                             wlk::grille_dense_3d<float> *Aj,
    ...
    float getResNorm() const
    {
        return mResNorm;
    }

    void setAccuracy(float set)
    {
        mAccuracy = set;
    }
