...
delegue_maillage::delegue_maillage(const maillage &m) : ptr_maillage(m)
{
}
...
dls::phys::esectd delegue_maillage::intersecte_element(long idx,
                                                       const dls::phys::rayond &rayon) const
{
    ...
    if (idx < ptr_maillage.nombre_triangles) {
        ...
        auto v0 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.triangles[idx_tri]]);
        auto v1 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.triangles[idx_tri + 1]]);
        auto v2 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.triangles[idx_tri + 2]]);
        ...
        auto v0 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.quads[idx_quad]]);
        auto v1 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.quads[idx_quad + 1]]);
        auto v2 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.quads[idx_quad + 2]]);
        auto v3 = dls::math::converti_type_point<double>(
            ptr_maillage.points[ptr_maillage.quads[idx_quad + 3]]);
...
maillage::maillage() : noeud(type_noeud::MAILLAGE), delegue(*this)
{
}
