...
class EntreeOperatrice {
  ...
  public:
     ...
     */
    Image const *requiers_image(ContexteEvaluation const &contexte,
                                DonneesAval *donnees_aval,
                                int index = 0);

    Image *requiers_copie_image(Image &image,
    ...
    Corps *requiers_copie_corps(Corps *corps,
                                ContexteEvaluation const &contexte,
                                DonneesAval *donnees_aval,
                                int index = 0);
...
class OperatriceImage : public danjo::Manipulable {
  ...
  public:
     ...
     * spécifiée.
     */
    virtual void obtiens_liste(ContexteEvaluation const &contexte,
                               dls::chaine const &attache,
                               dls::tableau<dls::chaine> &chaines);

    virtual void renseigne_dependance(ContexteEvaluation const &contexte,
