...
void Objet::performe_versionnage()
{
    if (this->noeud->propriete("pivot") == nullptr) {
        this->noeud->ajoute_propriete(
            "pivot", danjo::TypePropriete::VECTEUR, dls::math::vec3f(0.0f));
        this->noeud->ajoute_propriete(
            "position", danjo::TypePropriete::VECTEUR, dls::math::vec3f(0.0f));
        this->noeud->ajoute_propriete(
            "echelle", danjo::TypePropriete::VECTEUR, dls::math::vec3f(1.0f));
        this->noeud->ajoute_propriete(
            "rotation", danjo::TypePropriete::VECTEUR, dls::math::vec3f(0.0f));
        this->noeud->ajoute_propriete("echelle_uniforme", danjo::TypePropriete::DECIMAL, 1.0f);
        this->noeud->ajoute_propriete(
            "nom", danjo::TypePropriete::CHAINE_CARACTERE, dls::chaine("objet"));
