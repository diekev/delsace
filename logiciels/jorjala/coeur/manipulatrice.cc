...
static bool entresecte_min_max(dls::math::vec3f const &min,
...
bool entresecte_plan(Plan const &plan,
                     dls::math::point3f const &orig,
                     dls::math::vec3f const &dir,
                     float &t)
{
...
ManipulatricePosition3D::ManipulatricePosition3D()
    : m_min(dls::math::vec3f(-RAYON_POIGNEE)), m_max(dls::math::vec3f(1.0f + RAYON_POIGNEE)),
...
bool ManipulatricePosition3D::entresecte(dls::math::point3f const &orig,
                                         dls::math::vec3f const &dir)
{
...
bool ManipulatriceEchelle3D::entresecte(dls::math::point3f const &orig,
                                        dls::math::vec3f const &dir)
{
    auto dir_inverse = dls::math::vec3f(0.0f);
...
bool ManipulatriceRotation3D::entresecte(dls::math::point3f const &orig,
                                         dls::math::vec3f const &dir)
{
    auto dir_inverse = dls::math::vec3f(0.0f);
