                                         ...
                                         JJL::Jorjala &jorjala)
{
    ...
    données_programme->repondant_commande = memoire::loge<RepondantCommande>(
        "RepondantCommande", *données_programme->usine_commande, jorjala);
...
danjo::DonneesInterface cree_donnees_interface_danjo(JJL::Jorjala &jorjala,
...
Jorjala::Jorjala()
    : m_usine_commande{}, m_usine_operatrices{},
      m_repondant_commande(
          memoire::loge<RepondantCommande>("RepondantCommande", m_usine_commande, this)),
      fenetre_principale(nullptr), editrice_active(nullptr),
      gestionnaire_entreface(
          memoire::loge<danjo::GestionnaireInterface>("danjo::GestionnaireInterface")),
      project_settings(memoire::loge<ProjectSettings>("ProjectSettings")),
      camera_2d(memoire::loge<vision::Camera2D>("vision::Camera2D")),
      camera_3d(memoire::loge<vision::Camera3D>("vision::Camera3D", 0, 0)), graphe(nullptr),
      type_manipulation_3d(MANIPULATION_POSITION), chemin_courant("/objets/"),
      notifiant_thread(nullptr), chef_execution(*this), lcc(memoire::loge<lcc::LCC>("LCC"))
{
