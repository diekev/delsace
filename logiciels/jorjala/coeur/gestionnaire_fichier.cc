...
PoigneeFichier::PoigneeFichier(dls::chaine const &chemin) : m_chemin(chemin)
{
}
...
void PoigneeFichier::lecture_chemin(type_fonction_lecture_chemin &&fonction,
                                    const std::any &donnees)
{
    m_mutex.lock();
    {
...
void PoigneeFichier::ecriture_chemin(type_fonction_lecture_chemin &&fonction,
                                     const std::any &donnees)
{
    m_mutex.lock();
    {
