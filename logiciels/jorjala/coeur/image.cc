...
calque_image calque_image::construit_calque(wlk::base_grille_2d::type_desc const &desc,
                                            wlk::type_grille type_donnees)
{
    ...
    switch (type_donnees) {
        ...
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<unsigned int>>("grille_dense_2d",
                                                                                desc);
            break;
        }
        ...
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<float *>>("grille_dense_2d",
                                                                           desc);
            break;
        }
        ...
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<dls::math::vec2f>>(
                "grille_dense_2d", desc);
            break;
        }
        case wlk::type_grille::VEC3:
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<dls::math::vec3f>>(
                "grille_dense_2d", desc);
            break;
        }
        case wlk::type_grille::VEC3_R64:
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<dls::math::vec3d>>(
                "grille_dense_2d", desc);
            break;
        }
        case wlk::type_grille::COULEUR:
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<dls::phys::couleur32>>(
                "grille_dense_2d", desc);
            break;
        }
        case wlk::type_grille::COURBE_PAIRE_TEMPS:
        {
            calque.tampon() = memoire::loge<wlk::grille_dense_2d<wlk::type_courbe>>(
                "grille_dense_2d", desc);
            break;
        }
    }
...
calque_image *Image::ajoute_calque(dls::chaine const &nom,
...
calque_image *Image::ajoute_calque_profond(const dls::chaine &nom,
                                           wlk::desc_grille_2d const &desc,
                                           wlk::type_grille type)
{
    auto calque = memoire::loge<calque_image>("calque_image");
