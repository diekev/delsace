...
mot_cles = [
    ...
    u'xor',
    u'xor_eq',
    # Ceux-là ont une signification précise dans certains contextes, peuvent
...
digraphes = [
	...
	[u'^=', u'OUX_EGAL'],
	[u'::', u'SCOPE'],
	[u'//', u'DEBUT_COMMENTAIRE_CPP'],
	[u'/*', u'DEBUT_COMMENTAIRE_C'],
	[u'*/', u'FIN_COMMENTAIRE_C'],
]
