...
void ControleRoueCouleur::paintEvent(QPaintEvent *)
{
    ...
    painter.drawEllipse(
        QRectF(DECALAGE_CERCLE, DECALAGE_CERCLE, DIAMETRE_CERCLE, DIAMETRE_CERCLE));
    ...
    painter.drawLine(decalage_largeur,
                     static_cast<int>(hauteur * DECALAGE_CIBLE),
                     decalage_largeur,
                     hauteur_cible);
    painter.drawLine(static_cast<int>(largeur * DECALAGE_CIBLE),
                     decalage_hauteur,
                     largeur_cible,
                     decalage_hauteur);
    ...
    painter.drawArc(
        QRectF(DECALAGE_ROUE, DECALAGE_ROUE, DIAMETRE_ROUE, DIAMETRE_ROUE), 0.0, 5760.0);
