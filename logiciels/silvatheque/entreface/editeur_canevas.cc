...
VueCanevas::VueCanevas(Silvatheque *silvatheque, QWidget *parent)
	: QGLWidget(parent)
	, m_visionneur_scene(new VisionneurScene(this, silvatheque))
...
void VueCanevas::mousePressEvent(QMouseEvent *e)
{
	...
	m_silvatheque->repondant_commande->appele_commande("vue_3d", donnees);
}
...
void VueCanevas::mouseMoveEvent(QMouseEvent *e)
{
	...
	m_silvatheque->repondant_commande->ajourne_commande_modale(donnees);
}
...
void VueCanevas::mouseReleaseEvent(QMouseEvent *e)
{
	...
	m_silvatheque->repondant_commande->acheve_commande_modale(donnees);
}

/* ************************************************************************** */

EditeurCanevas::EditeurCanevas(Silvatheque &silvatheque, QWidget *parent)
	: BaseEditrice(silvatheque, parent)
	, m_vue(new VueCanevas(&silvatheque, this))
{
