...
namespace Menge {
	 ...
	 */
	MENGE_API float toFloat( const std::string & value ) noexcept(false);
	 ...
	 */
	MENGE_API int toInt( const std::string & value ) noexcept(false);
	 ...
	 */
	MENGE_API size_t toSize_t( const std::string & value ) noexcept(false);
}	// namespace Menge
